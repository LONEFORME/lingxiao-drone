...
class Task2FlightMission(mission):
    ...
    def _preserve_retakeoff_t265_continuity(
        ...
        *,
        ...
        post-retakeoff stabilization and RETURN_H.  Only one short recovery
        window is allowed; a later independent jump is still handled by the
        normal safety monitor and forces HOVER_WAIT.
        """
